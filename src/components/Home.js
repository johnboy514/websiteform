        ...
        <div className="px-4 py-5 px-md-5 text-center text-lg-start">
          <div className="container">
            <div className="row gx-lg-5 align-items-center">
              <div className="mb-5 mb-lg-0 mt-5 slideInLeft" style={{ backgroundColor: 'rgba(221, 161, 94, 0.9)' , border: "solid" , borderColor: "#283618" }}>
              ...
              <div className="mb-5 mb-lg-0 slideInRight">
                <div className="requestQuoteCard" style={{ 
                  ...
                  <h4 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script, cursive"}}>Contact Information:</h4>
                    <Form onSubmit={handleSubmit} className="px-3">
                      ...
                      <Form.Group className="mb-3" controlId="formOrg">
                        <Form.Control type="email" ref={email} placeholder={"Company/Organization Name (if applicable)"}  title="Company/Organization Name (if applicable)" />
                        {visible2 && <div className="text-danger">Please enter your Company/Organization</div>}
                      </Form.Group>

                    <h4 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script, cursive"}}>Project Overview:</h4>

                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>Briefly describe your company/organization and its purpose:</h5>
                      ...
                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>What is the primary goal of your website? (e.g., showcase products/services, generate leads, provide information):</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
                      ...
                      <h4 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script, cursive"}}>Design Preferences:</h4>

                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>Describe the overall style or theme you envision for your website:</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
                      ...
                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>Are there any specific color schemes:</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
                      <Form.Control as="textarea" ref={message} rows={3} placeholder="Are there any specific color schemes"/>
                        {visible1 && <div className="text-danger">Please enter your message</div>}
                      </Form.Group>

                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>Branding guidelines to adhere to:</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
                      <Form.Control as="textarea" ref={message} rows={3} placeholder="Branding guidelines to adhere to"/>
                        {visible1 && <div className="text-danger">Please enter your message</div>}
                      </Form.Group>

                      <h4 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script, cursive"}}>Functionality and Features:</h4>

                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>List the main pages or sections you envision for your website (e.g., Home, About Us, Services, Contact):</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
                      ...
                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>Are there any specific features or functionalities you would like to include? (e.g., contact form, e-commerce, blog):</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
                      ...
                      <h4 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script, cursive"}}>Competitor Analysis:</h4>

                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>Provide links to websites of your competitors or similar businesses. What do you like/dislike about their websites?</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
                      ...
                      <h4 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script, cursive"}}>Content:</h4>

                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>Do you already have written content for the website, or do you need assistance with content creation?</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
                      ...
                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>Are there any specific images or multimedia elements you want to include?</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
                      <Form.Control as="textarea" ref={message} placeholder="Yes/No"/>
                        {visible1 && <div className="text-danger">Please enter your message</div>}
                      </Form.Group>

                      <h4 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script, cursive"}}>Additional Information:</h4>

                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>Are there any specific websites you admire in terms of design or functionality?</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
                      <Form.Control as="textarea" ref={message} rows={3} placeholder="Please link the sites you like and reasons why!"/>
                        {visible1 && <div className="text-danger">Please enter your message</div>}
                      </Form.Group>

                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>Is there anything else you would like to share or discuss regarding your website project?</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
                      ...
                      <h5 className="text-center" style={{color: "#fefae0", fontFamily: "Dancing Script"}}>If you have an instagram or any social media you feel would help be get an idea of what you like aesthetically link it</h5>
                      <Form.Group className="mb-3" controlId="formBrief">
